...
TEST(DashboardHtmlTest, IncludesRuntimeConfigSummaryPruneAndInspectorControls) {
    ...
    EXPECT_NE(html.find("renderRuntimeDiffOutput"), std::string::npos);
    EXPECT_NE(html.find("runtime-diff-output"), std::string::npos);
    EXPECT_NE(html.find("runtime-diff-structured"), std::string::npos);
    EXPECT_NE(html.find("runtime-diff-entry"), std::string::npos);
    EXPECT_NE(html.find("runtime-diff-change-label"), std::string::npos);
    EXPECT_NE(html.find("Before"), std::string::npos);
    EXPECT_NE(html.find("After"), std::string::npos);
    EXPECT_NE(html.find("runtime-diff-empty-state"), std::string::npos);
    EXPECT_NE(html.find("No runtime config differences between selected versions."), std::string::npos);
    EXPECT_NE(html.find("runtime-diff-unavailable-state"), std::string::npos);
